...
<img class="gif" src="img/plasma_demo.gif" alt="plasma disruption animation" class="inline"/><br>
...
<img class="gif" src="img/gif_res.gif" alt="prostate segmentation animation" class="inline"/><br>
